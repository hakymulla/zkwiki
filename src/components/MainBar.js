import { addDocument, findDocument } from "../api/fauna";
        ...
        if (window.ethereum) {
            ...
            try {
                ...
                if (isAvailable) {
                    ...
                    await addDocument(msgHash, msgBody)
                        .then((res) => {
                            console.log("Saved Successfully to Fauna DB");
                        }
                        )
                }
    ...
    const handleReveal = async (e) => {
        ...
        if (!window.ethereum) {
            ...
            try {
                ...
                const msgbody = await findDocument(msgHash);
